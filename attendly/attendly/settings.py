"""
Django settings for attendly project.
...
SECRET_KEY = 'django-insecure-p)a5z-!d88++k2q@1lxu8^nh__cg0(ww+gq6q_dgjn()wji52('
...
JAZZMIN_SETTINGS = {
    ...
    "site_title": "Attendly Super Admin panel",

    # Title on the login screen (19 chars max) (defaults to current_admin_site.site_header if absent or None)
    "site_header": "Attendly",

    # Title on the brand (19 chars max) (defaults to current_admin_site.site_header if absent or None)
    "site_brand": "Attendly",

    # Welcome text on the login screen
    "welcome_sign": "Welcome to the Attendly",

    # Copyright on the footer
    "copyright": "Attendly Ltd",
